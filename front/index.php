...
$result=$photoCore1C->afficherphoto($connect);
?>
			...
			<div class="inner-sec-shop px-lg-4 px-3">
				...
				<div class="testimonials py-lg-4 py-3 mt-4">
					<div class="testimonials-inner py-lg-4 py-3">
						<h3 class="tittle-w3layouts text-center my-lg-4 my-4">Offres Speciales ci Dessous</h3>
				...
				<div class="row galsses-grids pt-lg-5 pt-3">
					...
					<div class="col-lg-6 galsses-grid-left">
						<figure class="effect-lexi">
							<img src="<?php echo '../upload/'.$row['image']; ?> " alt="" class="img-fluid"/>
	...
	<footer class="py-lg-5 py-3">
		<div class="container-fluid px-lg-5 px-3">
			...
			<div class="copyright-w3layouts mt-4">
				<p class="copy-right text-center ">&copy; 2018 AfricOptic. All Rights Reserved | Design by
					The Pionners 
				</p>
			</div>
		</div>
